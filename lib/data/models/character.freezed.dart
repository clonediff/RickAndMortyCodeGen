...
class _$CharacterImpl implements _Character {
  ...
  @override
  String toString() {
    return 'Character(id: $id, name: $name, status: $status, species: $species, gender: $gender, image: $image)';
  }
...
abstract class $CharactersResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Character> results, Info info});
...
class _$CharactersResponseImpl implements _CharactersResponse {
  const _$CharactersResponseImpl(
      {required final List<Character> results, required this.info})
      : _results = results;
  ...
  @override
  String toString() {
    return 'CharactersResponse(results: $results, info: $info)';
  }
...
abstract class _CharactersResponse implements CharactersResponse {
  const factory _CharactersResponse(
      ...
      required final Info info}) = _$CharactersResponseImpl;
